 ...
 *
 */
public class ME_Capture implements Capture {
    ...
    public ME_Capture(Connection con) {
    ...
    public String createCaptureCommand() {
        ...
        String command = String.format("ME%04d%04d%02d%01d%02d\n",
    ...
    /* (non-Javadoc)
     * @see com.kristou.urgLibJ.RangeSensor.Capture.Capture#capture(com.kristou.urgLibJ.RangeSensor.Capture.CaptureSettings)
     */
    @Override
...
//					// ////////////
                    ...
                    String itensityPart = dataPeiece.substring(dataSize / 2, dataSize);
    ...
    public boolean start() {
        String command = createCaptureCommand();
        if (command == null) {
            error_message = "Command could not be created";
            return false;
        }
