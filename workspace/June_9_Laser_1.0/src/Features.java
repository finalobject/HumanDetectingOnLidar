...
public class Features {
	...
	public double[] getLables(int length,int[] a){
	...
	public static void main(String[] args) {
		...
		double[][] features={fea1.LOS,fea1.MCCOS};
		double[] lables =fea1.getLables(features[0].length,new int[]{15,16});
		
		//double[] qw = {4382.975426174424,10449.038654869822,942.7782562674089,451.0902719614609,546.7742028227258,8073.75285023907,4087.479916424864,200.0};
		...
		//double[][] features={qw,fea2};
		//double[] lables= fea1.getLables(features[0].length, new int[]{3,4});
